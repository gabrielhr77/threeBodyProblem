...
def main():
    ...
    lua = Planeta('Lua', (128, 128, 128), (128, 128, 128), 624, 350, 500, 15, 90, 5)
    terra = Planeta('Terra', (0, 0, 255), (0, 0, 255), 412, 350, 500, 15, -90, 7)
    sol = Planeta('Sol', (255,255,0),(255,255,0),250,250,500,15,45,7)
    rodando = True
